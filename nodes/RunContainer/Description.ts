...
export const mainProperties: INodeProperties[] = [
    ...
    },
    {
        ...
        type: 'string',
        default: 'Runs a Docker container with the specified image, command, and arguments. Automatically executes the container and returns stdout, stderr, and exit code. Use this tool whenever you need to run code, execute commands, or test something in an isolated Docker environment. Provide the image name (e.g., "alpine:latest", "python:3.11"), the command to run (e.g., "echo", "python"), and any arguments.',
    ...
    },
    {
        ...
        default: '',
        required: true,
        placeholder: 'e.g., echo "Hello World" or python /app/script.py',
    ...
    },
    {
        ...
        default: '',
        required: true,
        placeholder: 'e.g., --name mycontainer --count 5',
